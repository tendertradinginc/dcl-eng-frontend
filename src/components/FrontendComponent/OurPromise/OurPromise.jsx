...
const OurPromise = () => {
  return (
    <div
      ...
      className="md:py-20 bg-center bg-no-repeat bg-cover md:mb-20"
    >
      <MaxWidthWrapper>
        <div className="mb-10 lg:hidden">
          <h1 className="text-4xl font-bold text-[#0B0B0B] text-center mb-4">
            RF Dewi Expanded
          </h1>

          <div>
            <div className="flex gap-3 mt-10 text-justify text-base md:text-lg">
